...
with open('/hpctmp/e0643891/exp/cstrPho0.001_HardDiff0.0015_selfcstr0_veri0.5_same11_c2_3s/scores/clean.kaldi0.pho_score','r') as file:
...
plt.savefig('/hpctmp/e0643891/exp/cstrPho0.001_HardDiff0.0015_selfcstr0_veri0.5_same11_c2_3s/scores/librispeech_score_distribution.png')
